...
- Name: a11y.spec.ts >> light theme >> export modal has no serious/critical violations when open
- Location: tests/e2e/a11y.spec.ts:48:9

# Error details

```
Error: 1 axe violation(s) on light theme > tips export modal:
      ...
      - generic [ref=e180]:
        - generic [ref=e181]:
          ...
          - button "Close" [ref=e183]:
            - img
        - group "Format" [ref=e184]:
          - generic [ref=e185]: Format
          - generic [ref=e186]:
            - generic [ref=e187]:
              - radio "CSVSpreadsheet-compatible" [checked] [ref=e188]
              - text: CSVSpreadsheet-compatible
            - generic [ref=e189]:
              - radio "Excel (.xlsx)Microsoft Excel" [ref=e190]
              - text: Excel (.xlsx)Microsoft Excel
            - generic [ref=e191]:
              - radio "PDF — Transaction listPrintable table" [ref=e192]
              - text: PDF — Transaction listPrintable table
            - generic [ref=e193]:
              - radio "PDF — Tax reportAnnual summary" [ref=e194]
              - text: PDF — Tax reportAnnual summary
            - generic [ref=e195]:
              - radio "CSV — Tax reportAnnual summary" [ref=e196]
              - text: CSV — Tax reportAnnual summary
        - group "Date Range" [ref=e197]:
          - generic [ref=e198]: Date Range
          - generic [ref=e199]:
            - button "All time" [ref=e200]
            - button "This year" [ref=e201]
            - button "Last year" [ref=e202]
            - button "Custom range" [ref=e203]
        - paragraph [ref=e204]: 8 transactions will be exported
        - generic [ref=e205]:
          - button "Cancel" [ref=e206]
