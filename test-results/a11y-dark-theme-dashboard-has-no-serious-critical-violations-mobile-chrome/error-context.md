...
- Name: a11y.spec.ts >> dark theme >> dashboard has no serious/critical violations
- Location: tests/e2e/a11y.spec.ts:28:11

# Error details

```
Error: 1 axe violation(s) on dark theme > dashboard:
...
- generic [active] [ref=e1]:
  - generic:
    ...
    - paragraph: An unexpected error occurred. You can try again or refresh the page.
    - generic: Maximum update depth exceeded. This can happen when a component repeatedly calls setState inside componentWillUpdate or componentDidUpdate. React limits the number of nested updates to prevent infinite loops.
    - generic:
      - button "Try again" [ref=e3]
      - button "Go home" [ref=e4]
  - generic [ref=e5]:
    - img [ref=e7]
