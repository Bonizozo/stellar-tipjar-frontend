...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e510]:
    ...
    - button "Open Tanstack query devtools" [ref=e560] [cursor=pointer]:
      - img [ref=e561]
  - alert [ref=e611]
  - button "Skip tour" [ref=e612] [cursor=pointer]
  - 'dialog "Tour step 1 of 6: Navigation" [ref=e613]':
    - heading "Navigation" [level=3] [ref=e622]
    - paragraph [ref=e623]: Use the navbar to explore the app, access your wallet, and switch themes.
    - generic [ref=e624]:
      - button "Skip tour" [ref=e625]
