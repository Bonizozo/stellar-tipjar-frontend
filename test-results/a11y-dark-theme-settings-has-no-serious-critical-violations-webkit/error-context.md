...
- Name: a11y.spec.ts >> dark theme >> settings has no serious/critical violations
...
Call log:
  - navigating to "http://localhost:3000/en/settings", waiting until "load"
...
- generic [ref=e3]:
  ...
  - region "Settings" [ref=e7]:
    - generic [ref=e9]:
      - link "Profile Edit your public creator profile and avatar" [ref=e10]:
        - /url: /profile
        - generic [ref=e11]:
          - img [ref=e13]
          - generic [ref=e15]:
        ...
        - img [ref=e18]
      - link "Notifications Control how and when you're notified" [ref=e20]:
