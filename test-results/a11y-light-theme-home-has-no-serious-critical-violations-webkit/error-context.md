...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e544]:
    ...
    - button "Open Tanstack query devtools" [ref=e614] [cursor=pointer]:
      - img [ref=e615]
  - alert [ref=e685]
  - button "Skip tour" [ref=e686] [cursor=pointer]
  - 'dialog "Tour step 1 of 6: Navigation" [ref=e687]':
    - heading "Navigation" [level=3] [ref=e696]
    - paragraph [ref=e697]: Use the navbar to explore the app, access your wallet, and switch themes.
    - generic [ref=e698]:
      - button "Skip tour" [ref=e699]
